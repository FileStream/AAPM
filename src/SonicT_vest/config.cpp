...
class CfgMagazines {
	...
	class SCT_plate_ceramic_4sas7_magtype: AAPM_Item_Base_magtype {
		...
		model = "\SCT\addons\SonicT_vest\data\objects\SAPI.p3d"
		descriptionShort = "Used By: Civilians<br />Rating: NIJ Level IV Ceramic, Boron Carbide<br />Introduced: 2000s<br />Rated against 30-06 M2AP";
		mass = 190;
		count = 56;
	...
	class SCT_plate_steel_ar5005_magtype: AAPM_Item_Base_magtype {
		scope = 2;
		displayName = "(Plate)MIL-V AR500 10X12";
		picture = "\SCT\addons\SonicT_vest\data\ar500.paa";
		model = "\SCT\addons\SonicT_vest\data\objects\SCT_steel_ar500_3p.p3d"
		descriptionShort = "Used By: Well-funded PMCs, well-connected survivalists<br />Rating: NIJ Level IV, MIL-V<br />Introduced: 2010s<br />Rated for 7N37/7N39/M995/M993";
		mass = 420;
		count = 3000;
		...
		class SCT_ITEMINFO{
			...
			blunttraumaPad[] = {0,0,0.78,0.78,0.78,0,0,0,0};
			enablePlace[] = {"Vest", "Uniform", "Backpack"};
		};
	};
	...
	class SCT_plate_steel_ar5005mc_magtype: AAPM_Item_Base_magtype {
		scope = 2;
		displayName = "(Plate)MIL-V AR500 11X14";
		picture = "\SCT\addons\SonicT_vest\data\ar500.paa";
		model = "\SCT\addons\SonicT_vest\data\objects\SCT_steel_ar500_3p.p3d"
		descriptionShort = "Used By: Well-funded PMCs, well-connected survivalists<br />Rating: NIJ Level IV, MIL-V, Maximum Coverage, Steel<br />Introduced: 2010s<br />Rated for 7N37/7N39/M995/M993";
		mass = 470;
		count = 3000;
		
		class SCT_ITEMINFO{
			plateinfo[] = {"AR500 Level V, Maximum Coverage", 2};
			enableparts[] = {5,5,19,19,19,0,0,0,0};
			blunttraumaPad[] = {0.14,0.14,0.79,0.79,0.79,0,0,0,0};
			enablePlace[] = {"Vest", "Uniform", "Backpack"};
		};
	};
